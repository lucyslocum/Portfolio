...
public class CardManager{
    ...
    public int computerDeal(boolean hermit, boolean magician, boolean lovers) {
        ...
        if (hermit == true) {
            System.out.println("The Hermit reveals the dealer's second card: " + compCard2);
        }
    ...
    public void gameResults(int playerScore, int compScore, boolean sun, boolean tower, boolean lovers, boolean hangedMan, boolean death, boolean magician, boolean wheel) {
        ...
        System.out.println("Initial Dealer's Score: " + compScore);
        if (sun == true) {
            playerScore += 5;
        }
        else if (tower == true) {
        ...
        System.out.println("Final Dealer's Score: " + compScore);
        if (playerScore > 21) {
